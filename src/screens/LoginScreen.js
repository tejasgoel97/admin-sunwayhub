...
export default function LoginScreen() {
    ...
    return( 
        <div className=" flex justify-center align-middle m-12">
            <div className=" shadow-2xl rounded px-8 pt-6 pb-8 mb-4 flex flex-col w-full sm:w-3/5 lg:w-2/5 bg-orange-100">
                <div className="mb-4">
                ...
                {!isPending &&<button 
                    className=" hover:bg-green-800 w-full text-white font-bold py-2 px-4 rounded border-1 border-slate-900 bg-green-600 align-middle" 
